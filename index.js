...
// Questions
var nodes = [{ "node": 1, "message": "Do you want a big dog", "yes": 2, "no": 3 },
             { "node": 2, "message": "Are you active", "yes": 4, "no": 5 },
             { "node": 3, "message": "Do you have allergies", "yes": 6, "no": 7 },
             { "node": 4, "message": "Are you looking for a guard dog", "yes": 8, "no": 9 },
             { "node": 5, "message": "Do you mind slobber", "yes": 10, "no": 11 },
             { "node": 6, "message": "Are you active", "yes": 12, "no": 13 },
             { "node": 7, "message": "Are you okay with a long-haired dog", "yes": 14, "no": 15 },

// Answers & descriptions
             { "node": 8, "message": "Rottweiler", "yes": 0, "no": 0, "description": "The Rottweiler is a breed of domestic dog, regarded as medium-to-large. The dogs were known in German as Rottweiler Metzgerhund, meaning Rottweil butchers' dogs, because one of their uses was to herd livestock and pull carts laden with butchered meat to market. Rottweilers are now used as search and rescue dogs, as guide dogs for the blind, as guard dogs and police dogs." },
             { "node": 9, "message": "Labrador", "yes": 0, "no": 0, "description": "The Labrador Retriever, also Labrador, is a type of retriever-gun dog. The Labrador is one of the most popular breeds of dog in the United Kingdom and the United States."},
             { "node": 10, "message": "Poodle", "yes": 0, "no": 0 , "description": "The Poodle is the second most intelligent dog breed just behind the Border Collie, and is skillful in many dog sports and activities, including agility, obedience, tracking to herding, circus performers or assistance dogs. They are also hypo-allergenic;"},
             { "node": 11, "message": "Bloodhound", "yes": 0, "no": 0 , "description": "The Bloodhound is a large scent hound, originally bred for hunting deer, wild boar, and since the Middle Ages for tracking people."},
             { "node": 12, "message": "Jack Russel Terrier", "yes": 0, "no": 0 , "description": "The Jack Russell Terrier is a small terrier that has its origins in fox hunting. It is principally white-bodied and smooth, rough or broken-coated."},
             { "node": 13, "message": "Pug", "yes": 0, "no": 0 , "description": "The Pug is a breed of dog with a wrinkly, short-muzzled face, and curled tail. The breed has a fine, glossy coat that comes in a variety of colours, most often fawn or black, and a compact square body with well-developed muscles."},
             { "node": 14, "message": "Dachshund", "yes": 0, "no": 0 , "description": "The dachshund is a short-legged, long-bodied, hound-type dog breed. The standard size dachshund was developed to scent, chase, and flush out badgers and other burrow-dwelling animals, while the miniature dachshund was bred to hunt smaller prey such as rabbits. In the United States, they have also been used to track wounded deer and hunt prairie dogs."},
             { "node": 15, "message": "Chihuahua", "yes": 0, "no": 0 , "description": "The Chihuahua is the smallest breed of dog and is named for the state of Chihuahua in Mexico. Chihuahuas come in a wide variety of sizes, head shapes, colors, and coat lengths."},
];
...
var welcomeMessage = "Welcome to dog breed picker, are you ready to play?";
...
var decisionMessage = "I think you should get a";

// This is the prompt to ask the user if they would like to hear a short description of thier chosen profession or to play again
var playAgainMessage = "Say 'tell me more' to hear a short description for this dog breed, or do you want to play again?";

// this is the help message during the setup at the beginning of the game
var helpMessage = "I will ask you some questions that will identify what dog breed you should get. Want to start now?";
